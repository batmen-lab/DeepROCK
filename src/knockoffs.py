...
Adopted from https://github.com/vanderschaarlab/mlforhealthlabpub/tree/main/alg/knockoffgan
Inputs:
x_train: Training data
lamda: Power network parameter = 0.01
mu: WGAN parameter = 1
"""
def KnockoffGAN(x_train, x_name="Uniform", lamda=1, mu=1, mb_size=128, niter=2000):
    ...
    x_knockoff = sample(x_train).copy()
    sess.close()
